...
describe('Oval Loader', () => {
  test('should be importable correctly', () => {
    const component = render(<Oval height={100} color={'red'} width={100} />)
    expect(component).toBeDefined()
  })

  test('should have a test classes', () => {
    render(<Oval height={100} color={'red'} width={100} />)
  ...
  test('should be hidden when visibile is false', () => {
    render(<Oval height={100} color={'red'} width={100} visible={false} />)
    const element = screen.getByTestId(wrapperTestId)
